...
if not act_macth_lib then
	...
	{ 
		...
		send_fajiang_msg = NULL_FUNC,		--发送发奖消息 
	 	...
	 	start_baoming_date = "2012-05-31",	--活动报名开始时间
		statime = "2012-05-31 02:00:00",  --活动开始时间
	    endtime = "2012-06-06 23:00:00",  --活动结束时间 
	    rank_endtime = "2012-06-08 00:00:00",	--排行榜结束时间
	      
	    start_day = 20120530,	--用于计算第几天 开始时间
